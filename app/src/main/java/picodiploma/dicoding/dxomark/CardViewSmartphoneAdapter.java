...
public class CardViewSmartphoneAdapter extends RecyclerView.Adapter<CardViewSmartphoneAdapter.CardViewViewHolder> {
    ...
    public CardViewSmartphoneAdapter(Context context) {
    ...
    public CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_cardview_smartphone, viewGroup, false);
        return new CardViewViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CardViewViewHolder cardViewViewHolder, int i) {
        Smartphone p = getListSmartphone().get(i);
        Glide.with(context)
                .load(p.getPhoto())
        ...
        cardViewViewHolder.btnFavorite.setOnClickListener(new CustomOnItemClickListener(i, new CustomOnItemClickListener.OnItemClickCallback() {
            ...
            public void onItemClicked(View view, int position) {
                Toast.makeText(context, "Favorite " + getListSmartphone().get(position).getName(), Toast.LENGTH_SHORT).show();
            }
        }));
