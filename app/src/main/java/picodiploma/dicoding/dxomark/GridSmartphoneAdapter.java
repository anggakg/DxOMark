...
public class GridSmartphoneAdapter extends RecyclerView.Adapter<GridSmartphoneAdapter.GridViewHolder>{
    ...
    public GridSmartphoneAdapter(Context context) {
    ...
    public GridViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_grid_smartphone, parent, false);
